...
fetch('https://api.jsonbin.io/v3/b/6340701b0e6a79321e207d0f?meta=false',{
    ...
    headers:{
        ...
        'X-Master-Key' : '$2b$10$/E4fwa/Mlke7U5IL.KyG3uDe7Tf.SCQ04HfekZlvKuo7ubwV74QNy',
        'X-Key-Name' : 'QUESTIONS'
    }
}
)
    .then((res) => {
...
//se cambian valores de la siguiente pregunta
getNewQuestion = () => {
...
//Se agregan los valores de las respuetsas
choices.forEach((choice) => {
...
//Se agregan puntos cuando la respuesta es correcta
incrementScore = (num) => {
    score += num;
